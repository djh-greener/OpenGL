...
LightingMapTest::LightingMapTest()
{
    ...
    ShaderCach["Default"] = make_shared<Shader>("res/shader/2Light/4LightingMap/Default.shader");
    ShaderCach["Second"] = make_shared<Shader>("res/shader/2Light/4LightingMap/FlipSpecular.shader");
    ...
    {//物体
        ...
        objects[0]->texs.push_back(make_shared<Texture>("res/image/lighting_maps_specular_color.png"));
